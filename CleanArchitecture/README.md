...
- 유스케이스 - 은행에서 대출 담당자가 신청자의 신상정보를 수집하여 검증한 후, 신천자의 신용도가 500보다 낮다면 대출 견적을 제공하지 않기로 결정한 것
...
- 프레임워크 독립성 - 아키텍처는 프레임워크의 존재 여부에 의존하지 안흔ㄴ다. 이를 통해 이러한 프레임워크를 도구로 사용할 수 있으며, 프레임워크가 지닌 제약사항안으로 시스템을 욱여 넣도록 강제하지 않는다.
